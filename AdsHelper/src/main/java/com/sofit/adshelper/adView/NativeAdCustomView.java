 ...
 */
public class NativeAdCustomView extends FrameLayout {

    private int templateType;
    private NativeTemplateStyle styles;
    private UnifiedNativeAd nativeAd;
    private NativeAdCustomView nativeAdView;
  ...
  public NativeAdCustomView(@NonNull Context context) {
    super(context);
  }

//    public NativeAdCustomView(Context context) {
//        super(context);
//    }
//
//    public NativeAdCustomView(Context context, @Nullable AttributeSet attrs) {
//        super(context, attrs);
//        initView(context, attrs);
//    }
//
//    public NativeAdCustomView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
//        super(context, attrs, defStyleAttr);
//        initView(context, attrs);
//    }
//
//    public NativeAdCustomView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//    }
    ...
    public NativeAdCustomView getNativeAdView() {
        return nativeAdView;
    }
...
//    nativeAdView.setWindowInsetsAnimationCallback(callToActionView);
...
//        context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.NativeAdView, 0, 0);
//
//    try {
//      templateType =
//          attributes.getResourceId(
//              R.styleable.NativeAdView_gnt_template_type, R.layout.gnt_medium_template_view);
//    } finally {
//      attributes.recycle();
//    }
